...
Pokemon::Pokemon(const std::string& p_name, PokemonType p_type, int p_health, int p_maxHealth, int p_attackPower) {
	m_name = p_name;
	m_type = p_type;
	m_health = p_health;
	m_maxHealth = p_maxHealth;
	m_attackPower = p_attackPower;
}
...
void Pokemon::heal() { m_health = m_maxHealth; }
